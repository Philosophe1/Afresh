...
const chrome = (progress = 1) => `
  ...
  <div style="display:flex;align-items:center;padding:4px 12px 8px;gap:6px;background:white;">
    ...
    <button style="display:flex;align-items:center;gap:6px;padding:9px 20px;border-radius:24px;background:${T.greenPrimary};border:1.5px solid ${T.greenPrimary};color:white;font-size:14px;font-weight:600;font-family:inherit;">
    ...
    <button style="display:flex;align-items:center;gap:6px;padding:9px 20px;border-radius:24px;background:white;border:1.5px solid ${T.border};color:${T.textSecondary};font-size:14px;font-weight:600;font-family:inherit;">
